...
<head>
    ...
    <title>{{ config('app.name', 'Smart Client') }} - @yield('title', 'Dashboard')</title>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('dashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2">{{ config('app.name', 'Smart Client') }}</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Files -->
                    <li class="menu-item {{ request()->routeIs('files.*') ? 'active' : '' }}">
                        <a href="{{ route('files.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-file"></i>
                            <div class="text-truncate">Files</div>
                        </a>
                    </li>

                    <!-- Contact Import -->
                    @if(auth()->user()->highlevel_connected)
                    <li class="menu-item {{ request()->routeIs('contact-import.*') ? 'active' : '' }}">
                        <a href="{{ route('contact-import.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-import"></i>
                            <div class="text-truncate">Contact Import</div>
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="menu-item {{ request()->routeIs('external-api.*') ? 'active' : '' }}">
                        <a href="{{ route('external-api.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-cloud-download"></i>
                            <div class="text-truncate">API Import</div>
                        </a>
                    </li>
                    @endif
                        ...
                        <div class="container-xxl">
                            <div class="footer-container d-flex align-items-center justify-content-between py-4 flex-md-row flex-column">
                                <div class="mb-2 mb-md-0">
                                    © {{ date('Y') }}, {{ config('app.name', 'Smart Client') }}
                                </div>
                            </div>
                        </div>
                    </footer>
